...
public class NavegacionListener implements LocationListener {

    NavegacionActivity navegacionActivity;

    public NavegacionActivity getNavegacionActivity() {
        return navegacionActivity;
    }

    public void setNavegacionActivity(NavegacionActivity navegacionActivity) {
        this.navegacionActivity = navegacionActivity;
    }
