...
public class IniciarViajeListener implements LocationListener {

    IniciarViajeActivity pedidoActualActivity;

    public IniciarViajeActivity getIniciarViajeActivity() {
        return pedidoActualActivity;
    }

    public void setIniciarViajeActivity(IniciarViajeActivity pedidoActualActivity) {
